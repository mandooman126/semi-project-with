 ...
 */
@WebServlet(name = "ReviewWriteFrm", urlPatterns = { "/reviewWriteFrm.do" })
public class ReviewWriteFrmServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/views/review/reviewWriteFrm.jsp");
