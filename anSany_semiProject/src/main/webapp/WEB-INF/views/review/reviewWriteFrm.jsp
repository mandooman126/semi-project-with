				...
				<table class="table table-borderless" id="reviewWrite">
					<tr class="table table-dark">
						...
						<td class="td-1" style="padding: 0;"><input type="text"
							name="reviewTitle" class="td-3" style="outline-style: none;"></td>
						<th class="th-1">첨부파일</th>
						<td style="text-align: left;"><input type="file"
							name="upfile" class="td-2"> <input type="hidden"
							name="reviewWriter" value="<%=m.getMemberId()%>"></td>
					</tr>
					<tr>
						<td colspan="4"
							style="text-align: left; padding: 0; padding-top: 8px;"><textarea
								id="reviewContent" name="reviewContent" class="input-form"></textarea></td>
					</tr>
					<tr>
						<td colspan="4">
