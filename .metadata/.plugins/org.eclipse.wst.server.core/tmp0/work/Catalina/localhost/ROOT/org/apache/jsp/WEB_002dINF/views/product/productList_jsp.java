 ...
 * Generated at: 2022-09-23 16:25:04 UTC
...
Member m = (Member) session.getAttribute("m");
      ...
      out.write("            <h2 class=\"product-top-title\">오디오</h2>\r\n");
      out.write("            <div class=\"product-top-category\">\r\n");
      out.write("                <div class=\"product-top-1\"><a href=\"#\">헤드셋/이어폰</a></div>\r\n");
      out.write("                <div class=\"product-top-2\"><a href=\"#\">스피커</a></div>\r\n");
      out.write("                <div class=\"product-top-3\"><a href=\"#\">턴테이블</a></div>\r\n");
      out.write("                <div class=\"product-top-4\"><a href=\"#\">워크맨/녹음기</a></div>\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"product-content\">\r\n");
      out.write("            <h2 class=\"product-content-title\">제품(");
      out.print(totalCount );
      out.write(")</h2>\r\n");
      out.write("            <div class=\"product-wrapper\">\r\n");
      out.write("                <!-- 상품 div 들어갈 공간 -->\r\n");
      out.write("                <!-- <form action=\"/productView.do\" method=\"post\">\r\n");
      out.write("                	<input type=\"hidden\" name=\"productNo\" value= %>>\r\n");
      out.write("                </form>\r\n");
      out.write("                 -->\r\n");
      out.write("            </div>\r\n");
      out.write("            <div class=\"more-btn-div\">\r\n");
      out.write("	            <button class=\"more-btn\" \r\n");
      out.write("	            totalCount=\"");
      out.print(totalCount);
      out.write("\" currentCount=\"0\" value=\"1\">제품 더보기 +</button>\r\n");
      out.write("            </div>\r\n");
      out.write("                ");
      out.write("\r\n");
      out.write("        </div>\r\n");
      ...
      out.write("		 	 const amount = 4; // 더보기 클릭 시 추가로 가져올 게시물 수\r\n");
      out.write("		 	 const start = $(this).val(); // 추가로 가져올 게시물 시작번호\r\n");
      out.write("			 $.ajax({\r\n");
      out.write("					url : \"/productMore.do\",\r\n");
      out.write("					type : \"post\",\r\n");
      ...
      out.write("							const a = $(\"<a>\");\r\n");
      out.write("							a.attr(\"href\",\"/productView.do?productNo=\"+p.productNo);\r\n");
      out.write("							\r\n");
      out.write("							const div = $(\"<div>\");\r\n");
      out.write("							div.addClass(\"product\");\r\n");
      out.write("							\r\n");
      out.write("							const imgDiv = $(\"<div>\");\r\n");
      out.write("							imgDiv.addClass(\"product-img\");\r\n");
      out.write("							\r\n");
      out.write("							const img = $(\"<img>\");\r\n");
      out.write("							img.attr(\"src\",\"/upload/prodImg/\"+p.productImg);\r\n");
      out.write("							\r\n");
      out.write("							imgDiv.append(img);\r\n");
      out.write("							\r\n");
      out.write("							const nameStrong = $(\"<strong>\");\r\n");
      out.write("							nameStrong.addClass(\"product-name\");\r\n");
      out.write("							nameStrong.append(p.productName);\r\n");
      out.write("							\r\n");
      out.write("							const infoP = $(\"<p>\");\r\n");
      out.write("							infoP.addClass(\"product-info\")\r\n");
      out.write("							infoP.append(p.productInfo);\r\n");
      out.write("							\r\n");
      out.write("							const priceSpan = $(\"<span>\");\r\n");
      out.write("							priceSpan.addClass(\"product-price\");\r\n");
      out.write("							priceSpan.append(addComma(p.productPrice)+\"원\");\r\n");
      out.write("							\r\n");
      out.write("								\r\n");
      out.write("							div.append(imgDiv);\r\n");
      out.write("							div.append(nameStrong);\r\n");
      out.write("							div.append(infoP);\r\n");
      out.write("							div.append(priceSpan);\r\n");
      out.write("							a.append(div);\r\n");
      out.write("							$(\".product-wrapper\").append(a);\r\n");
      out.write("						}\r\n");
      out.write("						// 화면 추가 완료 후 다음 더보기를 위한 값 수정\r\n");
      out.write("						// value를 증가 -> 기존 value + amount\r\n");
      out.write("						$(\".more-btn\").val(Number(start)+Number(amount));\r\n");
      out.write("						// currentCount값도 읽어온 만큼으로 수정\r\n");
      ...
      out.write("							$(\".more-btn\").remove(); // 더보기 버튼 없어지게\r\n");
      out.write("							$(\".more-btn\").attr(\"disabled\",true); // 더보기 비활성화\r\n");
      out.write("							$(\".more-btn\").css(\"cursor\",\"not-allowed\"); // 커서 모양 변환\r\n");
      out.write("						}\r\n");
      out.write("					},\r\n");
