 ...
 * Generated at: 2022-09-25 06:27:52 UTC
...
public final class freeBoardView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("kr.co.ansany.freeboard.model.vo.FreeBoardComment");
...
Member m = (Member) session.getAttribute("m");
      ...
      out.write("				<form action=\"/insertFcomment.do\" method=\"post\">\r\n");
      out.write("					<ul>\r\n");
      out.write("						<li><span class=\"material-icons\">person</span></li>\r\n");
      out.write("						<li><input type=\"hidden\" name=\"fCommentWriter\"\r\n");
      out.write("							value=\"");
      out.print(m.getMemberId());
      out.write("\"> <input type=\"hidden\"\r\n");
      out.write("							name=\"freeBoardRef\" value=\"");
      out.print(f.getFreeBoardNo());
      out.write("\"> <input\r\n");
      out.write("							type=\"hidden\" name=\"fCommentRef\" value=\"0\"> <textarea\r\n");
      out.write("								class=\"input-form\" name=\"fCommentContent\"></textarea></li>\r\n");
      out.write("						<li>\r\n");
      ...
      out.write("							<span>");
      out.print(fc.getfCommentWriter());
      out.write("</span> <span>");
      out.print(fc.getfCommentDate());
      out.write("</span>\r\n");
      out.write("						</p>\r\n");
      out.write("						<p class=\"comment-content\">");
      out.print(fc.getfCommentContent());
      out.write("</p>\r\n");
      out.write("						<textarea name=\"fCommentContent\" class=\"input-form\"\r\n");
      ...
      out.write("						<p class=\"comment-info\">\r\n");
      out.write("							<span>");
      out.print(fct.getfCommentWriter());
      out.write("</span> <span>");
      out.print(fct.getfCommentDate());
      out.write("</span>\r\n");
      out.write("						</p>\r\n");
      out.write("						<p class=\"comment-content\">");
      out.print(fct.getfCommentContent());
      out.write("</p> <textarea\r\n");
      out.write("							name=\"fCommentContent\" class=\"input-form\"\r\n");
      out.write("							style=\"min-height: 96px; display: none;\">");
      out.print(fct.getfCommentContent());
      out.write("</textarea>\r\n");
      out.write("						<p class=\"comment-link\">\r\n");
      ...
      out.print(f.getFreeBoardNo());
      out.write("\"> <input\r\n");
      out.write("								type=\"hidden\" name=\"fCommentRef\" value=\"");
      out.print(fc.getfCommentNo());
      out.write("\">\r\n");
      out.write("								<textarea class=\"input-form\" name=\"fCommentContent\"></textarea></li>\r\n");
      out.write("							<li>\r\n");
      out.write("								<button type=\"submit\" class=\"btn-repl\">댓글쓰기</button>\r\n");
      out.write("							</li>\r\n");
      out.write("						</ul>\r\n");
      ...
      out.write("		});\r\n");
      out.write("		\r\n");
      out.write("		function modifyComment(obj,fCommentNo,freeBoardNo) {\r\n");
      out.write("			$(obj).parent().prev().show();\r\n");
      out.write("			$(obj).parent().prev().prev().hide();\r\n");
      out.write("			$(obj).text(\"수정\");\r\n");
      out.write("			$(obj).attr(\"onclick\",\"modifyComplete(this,\"+fCommentNo+\",\"+freeBoardNo+\")\");\r\n");
      out.write("			\r\n");
      out.write("			$(obj).next().text(\"취소\");\r\n");
      out.write("			$(obj).next().attr(\"onclick\",\"modifyCancle(this,\"+fCommentNo+\",\"+freeBoardNo+\")\");\r\n");
      out.write("			\r\n");
      out.write("			$(obj).next().next().hide();\r\n");
      out.write("		}\r\n");
      out.write("		function modifyCancle(obj,fCommentNo,freeBoardNo){\r\n");
      out.write("			$(obj).parent().prev().hide();\r\n");
      out.write("			$(obj).parent().prev().prev().show();\r\n");
      out.write("			\r\n");
      out.write("			$(obj).prev().text(\"수정\");\r\n");
      out.write("			$(obj).prev().attr(\"onclick\",\"modifyComment(this,\"+fCommentNo+\",\"+freeBoardNo+\")\");\r\n");
      out.write("			$(obj).text(\"삭제\");\r\n");
      out.write("			$(obj).attr(\"onclick\",\"deleteComment(this,\"+fCommentNo+\",\"+freeBoardNo+\")\");\r\n");
      out.write("			$(obj).next().show();\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		function modifyComplete(obj,fCommentNo,freeBoardNo){\r\n");
      out.write("			const form = $(\"<form action='/freeBoardCommentUpdate.do' method='post'></form>\");\r\n");
      out.write("			const fCommentInput = $(\"<input type ='text' name='fCommentNo'>\");\r\n");
      out.write("			fCommentInput.val(fCommentNo);\r\n");
      out.write("			form.append(fCommentInput);\r\n");
      out.write("			const freeBoardInput = $(\"<input type='text' name='freeBoardNo'>\");\r\n");
      out.write("			freeBoardInput.val(freeBoardNo);\r\n");
      out.write("			form.append(freeBoardInput);\r\n");
      out.write("			const fCommentContent = $(obj).parent().prev();\r\n");
      out.write("			form.append(fCommentContent);\r\n");
      out.write("			$(\"body\").append(form);\r\n");
      out.write("			form.submit();\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		function deleteComment(obj,fCommentNo,freeBoardNo){\r\n");
      out.write("			if(confirm(\"댓글을 삭제하시겠습니까?\")){\r\n");
      out.write("				location.href = \"/deleteFreeBoardComment.do?fCommentNo=\"+fCommentNo+\"&freeBoardNo=\"+freeBoardNo;\r\n");
      out.write("			}\r\n");
      out.write("		}\r\n");
      out.write("	</script>\r\n");
      out.write("	");
