 ...
 * Generated at: 2022-09-25 06:42:00 UTC
...
public final class reviewView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("javax.swing.plaf.synth.SynthOptionPaneUI");
    _jspx_imports_classes.add("kr.co.ansany.review.model.vo.Review");
    _jspx_imports_classes.add("kr.co.ansany.review.model.vo.ReviewComment");
...
Member m = (Member) session.getAttribute("m");
      ...
      out.write("			<div class=\"page-title\">구매후기</div>\r\n");
      out.write("			");
      ...
      out.write(");\">삭제</button>\r\n");
      out.write("					<a href=\"/reviewUpdateFrm.do?reviewNo=");
      out.print(r.getReviewNo());
      out.write("\">수정</a>\r\n");
      out.write("				</div>\r\n");
      out.write("			</div>\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("			<table class=\"table table-group-divider\" id=\"reviewView\">\r\n");
      ...
      out.write("					<th>조회수</th>\r\n");
      out.write("					<td>");
      out.print(r.getReviewReadCount());
      out.write("</td>\r\n");
      out.write("					<th>작성일</th>\r\n");
      out.write("					<td>");
      ...
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<th>리뷰사진</th>\r\n");
      out.write("					<td colspan=\"9\">\r\n");
      out.write("						<div id=\"reviewImg\">\r\n");
      out.write("							");

							if (r.getReviewFilename() != null) {
							
      out.write("\r\n");
      out.write("							<img src=\"/upload/review/");
      out.print(r.getReviewFilepath());
      out.write("\" alt=\"\">\r\n");
      out.write("							");
      ...
      out.print(r.getReviewContentBr());
      out.write("</div>\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("			</table>\r\n");
      ...
      out.write("				<form action=\"/insertRcomment.do\" method=\"post\">\r\n");
      out.write("					<ul>\r\n");
      out.write("						<li><span class=\"material-icons\">person</span></li>\r\n");
      out.write("						<li><input type=\"hidden\" name=\"rCommentWriter\"\r\n");
      out.write("							value=\"");
      out.print(m.getMemberId());
      out.write("\"> <input type=\"hidden\"\r\n");
      out.write("							name=\"reviewRef\" value=\"");
      out.print(r.getReviewNo());
      out.write("\"> <input\r\n");
      out.write("							type=\"hidden\" name=\"rCommentRef\" value=\"0\"> <textarea\r\n");
      out.write("								class=\"input-form\" name=\"rCommentContent\"></textarea></li>\r\n");
      out.write("						<li>\r\n");
      ...
      out.write("							<span>");
      out.print(rc.getrCommentWriter());
      out.write("</span> <span>");
      out.print(rc.getrCommentDate());
      out.write("</span>\r\n");
      out.write("						</p>\r\n");
      out.write("						<p class=\"comment-content\">");
      out.print(rc.getrCommentContent());
      out.write("</p> <textarea\r\n");
      out.write("							name=\"rCommentContent\" class=\"input-form\"\r\n");
      ...
      out.write("						<p class=\"comment-info\">\r\n");
      out.write("							<span>");
      out.print(rct.getrCommentWriter());
      out.write("</span> <span>");
      out.print(rct.getrCommentDate());
      out.write("</span>\r\n");
      out.write("						</p>\r\n");
      out.write("						<p class=\"comment-content\">");
      out.print(rct.getrCommentContent());
      out.write("</p> <textarea\r\n");
      out.write("							name=\"rCommentContent\" class=\"input-form\"\r\n");
      out.write("							style=\"min-height: 96px; display: none;\">");
      out.print(rct.getrCommentContent());
      ...
      out.print(r.getReviewNo());
      out.write("\"> <input\r\n");
      out.write("								type=\"hidden\" name=\"rCommentRef\" value=\"");
      out.print(rc.getrCommentNo());
      out.write("\">\r\n");
      out.write("								<textarea class=\"input-form\" name=\"rCommentContent\"></textarea></li>\r\n");
      out.write("							<li>\r\n");
      out.write("								<button type=\"submit\" class=\"btn-repl\">댓글쓰기</button>\r\n");
      out.write("							</li>\r\n");
      out.write("						</ul>\r\n");
      ...
      out.write("	</div>\r\n");
      out.write("	<script>\r\n");
      out.write("		function reviewDelete(reviewNo){\r\n");
      out.write("			if(confirm(\"삭제하시겠습니까?\")) {\r\n");
      out.write("				location.href=\"/reviewDelete.do?reviewNo=\"+reviewNo;\r\n");
      out.write("			}\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      ...
      out.write("		});\r\n");
      out.write("		\r\n");
      out.write("		function modifyComment(obj,rCommentNo,reviewNo) {\r\n");
      out.write("			$(obj).parent().prev().show();\r\n");
      out.write("			$(obj).parent().prev().prev().hide();\r\n");
      out.write("			$(obj).text(\"수정\");\r\n");
      out.write("			$(obj).attr(\"onclick\",\"modifyComplete(this,\"+rCommentNo+\",\"+reviewNo+\")\");\r\n");
      out.write("			\r\n");
      out.write("			$(obj).next().text(\"취소\");\r\n");
      out.write("			$(obj).next().attr(\"onclick\",\"modifyCancle(this,\"+rCommentNo+\",\"+reviewNo+\")\");\r\n");
      out.write("			\r\n");
      out.write("			$(obj).next().next().hide();\r\n");
      out.write("		}\r\n");
      out.write("		function modifyCancle(obj,rCommentNo,reviewNo){\r\n");
      out.write("			$(obj).parent().prev().hide();\r\n");
      out.write("			$(obj).parent().prev().prev().show();\r\n");
      out.write("			\r\n");
      out.write("			$(obj).prev().text(\"수정\");\r\n");
      out.write("			$(obj).prev().attr(\"onclick\",\"modifyComment(this,\"+rCommentNo+\",\"+reviewNo+\")\");\r\n");
      out.write("			$(obj).text(\"삭제\");\r\n");
      out.write("			$(obj).attr(\"onclick\",\"deleteComment(this,\"+rCommentNo+\",\"+reviewNo+\")\");\r\n");
      out.write("			$(obj).next().show();\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		function modifyComplete(obj,rCommentNo,reviewNo){\r\n");
      out.write("			const form = $(\"<form action='/reviewCommentUpdate.do' method='post'></form>\");\r\n");
      out.write("			const rCommentInput = $(\"<input type ='text' name='rCommentNo'>\");\r\n");
      out.write("			rCommentInput.val(rCommentNo);\r\n");
      out.write("			form.append(rCommentInput);\r\n");
      out.write("			const reviewInput = $(\"<input type='text' name='reviewNo'>\");\r\n");
      out.write("			reviewInput.val(reviewNo);\r\n");
      out.write("			form.append(reviewInput);\r\n");
      out.write("			const rCommentContent = $(obj).parent().prev();\r\n");
      out.write("			form.append(rCommentContent);\r\n");
      out.write("			$(\"body\").append(form);\r\n");
      out.write("			form.submit();\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		function deleteComment(obj,rCommentNo,reviewNo){\r\n");
      out.write("			if(confirm(\"댓글을 삭제하시겠습니까?\")){\r\n");
      out.write("				location.href = \"/deleteReviewComment.do?rCommentNo=\"+rCommentNo+\"&reviewNo=\"+reviewNo;\r\n");
      out.write("			}\r\n");
      out.write("		}\r\n");
      out.write("	</script>\r\n");
      out.write("	");
